...
namespace geogebra\pci\model\update;
...
/**
 * Description of ItemGeoGebraDefaultValue
 *
 * @author sam
 */
class ItemFixGeoGebraDefaultValue extends ItemUpdater
{
    /**
    ...
    protected function updateItem(Item $item, $itemFile)
    {
        ...
        foreach ($interactions as $interaction) {
            if ($interaction instanceof PortableCustomInteraction && $interaction->getTypeIdentifier() === 'geogebra') {
